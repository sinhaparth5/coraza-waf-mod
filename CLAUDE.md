...
Run a single test: `go test ./proxy/ -run TestName -v` (substitute the package). Existing tests live in `proxy/`, `ratelimit/`, `ja3/`, `storage/`, `mailer/`, and `ui/`.
