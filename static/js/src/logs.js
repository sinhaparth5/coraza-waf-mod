(function () {
  ...
  function DatePicker(hiddenEl, btnEl, displayEl) {
    ...
    self.pop.style.cssText = 'display:none;box-shadow:0 4px 14px rgba(15,23,42,.12);width:272px;';
    self.pop.__dp = self;
  ...
  DatePicker.prototype.renderDays = function () {
    ...
    html += '<button type="button" class="dp-apply text-[13px] font-semibold text-white bg-brand px-4 py-[7px] rounded-md cursor-pointer">Apply</button>';
    html += '</div></div>';
